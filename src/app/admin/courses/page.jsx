...
export default function CoursesManager() {
  ...
  const handleMoveUp = async (course, school) => {
    ...
    [reorderedCourses[currentIndex - 1], reorderedCourses[currentIndex]] = [
      reorderedCourses[currentIndex],
      reorderedCourses[currentIndex - 1],
    ];
    ...
    try {
      await Promise.all(
        updates.map(({ id, order }) => API.put(`/courses/${id}`, { order })),
      );
      fetchCourses();
    } catch (error) {
        ...
        <Activity mode={showForm ? "visible" : "hidden"}>
          ...
          >
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                This will be displayed in brackets below the program name on
                cards
              </p>
            </div>
            ...
            >
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                <input
                  ...
                  onChange={handleChange}
                  style={inp}
                  placeholder="bca-bachelor-of-computer-application"
                />
              </div>
              <div>
                <ImageUploader
            ...
            <div style={{ marginBottom: "16px" }}>
              <label style={lbl}>Learning Objectives (one per line)</label>
              <textarea
                name="objectives"
            ...
            <div style={{ marginBottom: "16px" }}>
              <label style={lbl}>Career Prospects (one per line)</label>
              <textarea
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    ...
                    {schoolCourses.length === 1 ? "Program" : "Programs"}
                  </p>
                </div>
                <div
                  style={{
              ...
              <Activity mode={isExpanded ? "visible" : "hidden"}>
                <div style={{ padding: "12px" }}>
                  ...
                  >
                    💡 <strong>Tip:</strong> Use arrow buttons (↑ ↓) to reorder
                    programs within this school. Click on the image area to
                    upload/change card images.
                  </div>
